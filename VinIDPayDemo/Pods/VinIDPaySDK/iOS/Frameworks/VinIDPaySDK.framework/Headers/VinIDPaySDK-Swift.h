...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VinIDPaySDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

enum VinIDPayStatus : NSInteger;

SWIFT_CLASS("_TtC11VinIDPaySDK8VinIDPay")
...
typedef SWIFT_ENUM(NSInteger, VinIDPayStatus, closed) {
